...
public class Setup {
  ...
  private final String[] folders = {".%1$sdata", ".%1$sresource", ".%1$sreports"};
  private final String[] files =
      {"bootstrap-tabs.js", "core.css", "jquery.js", "bootstrap.min.css"};
  ...
  public void checkFiles() {
    for (String string : files) {
      File file = new File(String.format(".%1$sreports%1$s%2$s", File.separator, string));
      if (!file.exists()) {
