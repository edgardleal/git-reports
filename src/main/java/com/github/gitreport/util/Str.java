...
public class Str {
   ...
   * OBS: no caso de espacos em branco, considera-se a string como nao vazia e nao nula. Se for
   * preciso fazer esta verificacao utilize desta forma: <br>
   * <br>
   * 
   ...
   * 
   * @param value : valor analizado
   * @param result : resultado caso seja nulo ou empty
  ...
  public static String clearSpaces(String value) {
    value = value.trim().replaceAll(" {2,20}", SPACE).replaceAll("[\n\t]+", EMPTY);
    return value;
  }

  /**
   * retorna o valor informado em "ifNull" caso o valor de "value" seja igual a null
   * 
   * @param value
   * @param ifNull
   * @return
  ...
  /**
   * Retorna uma <code>String</code> formada pelo caractere informado ( <code>_char</code>) repetido
   * o numero de vezes informado <br>
  ...
  /**
   * Retorna uma string precedida do caractere <code>_char</code> repetido ate que se complete <br>
  ...
  /**
   * Retorna uma string seguida ( a direita ) do caractere <code>_char</code> repetido ate que se
   * complete <br>
   * o tamanho informado no parametro <code>times</code> <br>
   * OBS: time eh o tamnaho final da string retornada
   * 
  ...
  /**
   * Return the value string limited to maxlength characters. If the string gets curtailed and the
   * suffix parameter is appended to it.
   * <p/>
  ...
  public static String toPascalCase(final String value) {
    return value.subSequence(0, 1).toString().toUpperCase() + value.subSequence(1, value.length());
  }
  ...
  public static String toCamelCase(final String value) {
    return value.subSequence(0, 1).toString().toLowerCase() + value.subSequence(1, value.length());
  }
}
