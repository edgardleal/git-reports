/**
 * **************************************************************************** Copyright (c) 2011
 * GitHub Inc. All rights reserved. This program and the accompanying materials are made available
...
public class Templates {
  ...
  public static Reader getTemplateReader(String name) {
    ...
    return new InputStreamReader(Templates.class.getClassLoader().getResourceAsStream(name));
  }
